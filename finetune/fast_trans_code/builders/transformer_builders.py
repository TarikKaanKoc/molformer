...
from ..recurrent.attention.self_attention import \
    RecurrentAttentionLayer
    #RecurrentCrossAttentionLayer
from ..recurrent.transformers import RecurrentTransformerEncoderPPLM 
...
from ..builders.attention_builders import AttentionBuilder, RecurrentAttentionBuilder
...
class RecurrentEncoderPPLMBuilder(BaseTransformerEncoderBuilder):
    """Build a transformer encoder for autoregressive processing of sequences.

    Example usage:

        builder = RecurrentEncoderPPLMBuilder()
        builder.n_layers = 12
        builder.n_heads = 8
        builder.feed_forward_dimensions = 1024
        builder.query_dimensions = 64
    ...
    def _get_encoder_class(self):
        ...
        return RecurrentTransformerEncoderPPLM
